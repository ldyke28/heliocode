...
file = np.loadtxt("/Users/ldyke/Desktop/Dartmouth/HSResearch/Code/Kepler/Python Orbit Code/datafiles/5pi6_2p262502e8.txt", delimiter=',')
...
#ax3d.set_ylim([-25, 25])
#ax3d.set_zlim([-25, 25])
ax3d.set_title("Phase space population at target (t $\\approx$ 7.170 years) drawn from Maxwellian at 100 au centered on vx = -26 km/s \
    \n Target at (-.866 au, .5 au, 0 au), Time Resolution Close to Target = 500 s")
plt.show()