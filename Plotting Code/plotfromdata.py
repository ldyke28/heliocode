...
file = np.loadtxt("C:/Users/lucas/OneDrive/Documents/Dartmouth/HSResearch/Paper 1/Draft 2 Data/cosexprp_5pi6_firstforcefree_centerzoom_cxi+cepi_tclose500_r=1au.txt", delimiter=',')
...
plt.scatter(vx[:], vy[:], c=f[:], marker='o', cmap='rainbow', norm=matplotlib.colors.LogNorm(vmin=10**(-300), vmax=10**(-40)))
