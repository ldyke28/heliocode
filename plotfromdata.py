...
file = np.loadtxt("C:/Users/lucas/OneDrive/Documents/Dartmouth/HSResearch/datafiles/cosexprp_5pi6_p1268y_center_cosexppi_tclose1000.txt", delimiter=',')
...
plt.scatter(vx[:]/1000, vy[:]/1000, c=f[:], marker='o', cmap='hsv', norm=matplotlib.colors.LogNorm(vmin=10**(-6), vmax=10**(-2)))
