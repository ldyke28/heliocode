...
inputfilename = "C:/Users/lukeb/Documents/Dartmouth/HSResearch/Cluster Runs/2026Data/lostpoints_271deg_ibexshifted_1monthshift_lya_Federicodist_datamu_nofilter_3500vres"
inputfile = np.loadtxt(inputfilename + ".txt", delimiter=',')
theta = 271 # angle with respect to upwind axis of target point
oneyear = 3.15545454545*10**7
# 120749800 for first force free
# 226250200 for second force free
finalt = (16/60)*oneyear # time to start backtracing
refdist = 70
