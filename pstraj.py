...
vxstart = np.arange(-10000, 000, 100)
vystart = np.arange(5000, 15000, 100)
...
if mode==3:
    ...
    file = open("C:/Users/lucas/OneDrive/Documents/Dartmouth/HSResearch/datafiles/p5s2adj_pi4_6p33275e9_str_center_arcs.txt", 'w')
