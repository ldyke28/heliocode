...
ystart = ibexpos[1]
zstart = ibexpos[2]
#vxstart = np.arange(-50000, -15000, 1000)
#vystart = np.arange(-30000, 7000, 1000)
#vxstart = np.arange(-35000, 000, 800)
#vystart = np.arange(22500, 42000, 500)
vxstart = np.arange(-25000, 25000, 700)
vystart = np.arange(-15000, 25000, 1000)
...
if mode==3:
    ...
    #file = open("C:/Users/lucas/OneDrive/Documents/Dartmouth/HSResearch/datafiles/p5s2adj_meddownwind_attractive_direct.txt", 'w')
    ...
    plt.suptitle('Phase space population at target (t = 6.3188e9 s) drawn from Maxwellian at 100 au centered on vx = -26 km/s')
