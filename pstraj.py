...
vxstart = np.arange(-45000, 5000, 800)
vystart = np.arange(-25000, 000, 800)
...
if mode==3:
    ...
    plt.suptitle('Phase space population at target (t = 6.049e9 s) drawn from Maxwellian at 100 au centered on vx = -26 km/s')
