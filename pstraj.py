...
vxstart = np.arange(0000, 30000, 250)
vystart = np.arange(-5000, 50000, 400)
...
if mode==3:
    ...
    file = open("C:/Users/lucas/OneDrive/Documents/Dartmouth/HSResearch/datafiles/p1fluccosexprp_17pi36_-5e7_indirect_cosexppi_tclose200.txt", 'w')
