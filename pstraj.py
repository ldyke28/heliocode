...
if mode==3:
    ...
    file = open("/Users/ldyke/Desktop/Dartmouth/HSResearch/Code/Kepler/Python Orbit Code/datafiles/norp_5pi6_6p25e9_direct_cosexppi.txt", "w")
    ...
    plt.title('Target at (-.866 au, .5 au), Time Resolution Close to Target = 400 s')
