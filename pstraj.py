...
vxstart = np.arange(-61000, 0000, 500)
...
def rpnoise(t):
    # taken from eq. 8 in https://articles.adsabs.harvard.edu/pdf/1995A%26A...296..248R
    omegat = 2*np.pi/(3.47*10**(8))*t
    omeganoiset = 2*np.pi/(4*2.333*10**6)*t # 2.333*10**6 s = period of 27 days (rotational period of the sun)
...
if mode==3:
    ...
    file = open("C:/Users/lucas/OneDrive/Documents/Dartmouth/HSResearch/datafiles/p1fluccosexprp_quarterfreq_pi4_1p207498e8_direct_cosexppi_tclose400.txt", 'w')
