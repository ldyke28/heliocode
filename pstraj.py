...
vxstart = np.arange(000, 20000, 150)
vystart = np.arange(25000, 75000, 400)
...
if mode==3:
    ...
    file = open("C:/Users/lucas/OneDrive/Documents/Dartmouth/HSResearch/datafiles/p1fluccosexprp_17pi36_0y_indirect_cosexppi_tclose200.txt", 'w')
