...
#vystart = np.arange(-12500, -7500, 40)
vzstart = 0
if mode==3:
    startt = finalt
    lastt = initialt
...
def rpnoise(t):
    ...
    return .75 + .243*np.cos(omegat - np.pi)*np.exp(np.cos(omegat - np.pi)) + .005*np.sin(omeganoiset)
...
if mode==3:
    ...
    file = open("C:/Users/lucas/OneDrive/Documents/Dartmouth/HSResearch/datafiles/p005fluccosexprp_5pi6_0y_center_cosexppi_tclose1000.txt", 'w')
