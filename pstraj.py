...
vxstart = np.arange(-60000, 10000, 1500)
vystart = np.arange(-45000, -5000, 1500)
...
if mode==3:
    ...
    file = open("C:/Users/lucas/OneDrive/Documents/Dartmouth/HSResearch/datafiles/p1fluccosexprp_35pi36_0y_direct_cosexppi_tclose400.txt", 'w')
