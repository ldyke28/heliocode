...
vxstart = np.arange(-32000, 12000, 250)
vystart = np.arange(41000, 54000, 80)
...
if mode==3:
    ...
    file = open("C:/Users/lucas/OneDrive/Documents/Dartmouth/HSResearch/datafiles/norp_5pi6_6p25e9_indirect_cosexppi_tclose200.txt", 'w')
